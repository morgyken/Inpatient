...
@extends('layouts.app')
@section('content_title','Confirm Discharge of Patient')
            ...
            <div class="form-horizontal">
                <form role="form">  
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-12 col-md-2" style="padding: 0 !important;">Discharge Type</label>
                    ...
                    <div class="case-type" style="display:none !important;">
                        <div class="case form-group req"><br/>
                            <label class="col-xs-12 col-sm-12 col-md-2" style="padding: 0 !important;">Date Of Death</label>
                            <div class="col-xs-12 col-sm-12 col-md-6" style="padding-top:5px !important;">
                        ...
                        <div class="case form-group req"><br/>
                            <label class="col-xs-12 col-sm-12 col-md-2" style="padding: 0 !important;">Time Of Death</label>
                            <div class="col-xs-12 col-sm-12 col-md-6" style="padding-top:5px !important;">
                        ...
                        <div class=" case form-group"><br/>
                            <label class="col-xs-12 col-sm-12 col-md-2" style="padding: 0 !important;">Case Note</label>
                            <div class="col-xs-12 col-sm-12 col-md-6" style="padding-top:5px !important;">
                    ...
                    <div class="summary-type" style="display:none !important;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0 !important;">
                             <div class="form-group">
                                <br/>
                                <label class="col-xs-12 col-sm-12 col-md-2" style="padding: 0 !important;">To Come Again</label>
                                <div class="col-xs-12 col-sm-12 col-md-6">
